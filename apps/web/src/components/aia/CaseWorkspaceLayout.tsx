    ...
    <div className="grid gap-4 lg:grid-cols-[280px_1fr_320px]">
      ...
      <aside className="space-y-4">
        ...
        <Card title="Gates (1–5)">
          ...
          <div className="mt-2 text-xs text-zinc-500">(Demo controls — wired later)</div>
        </Card>
      </aside>
      ...
      <section className="space-y-4">
        <div className="rounded-xl border border-zinc-200 bg-white p-4 shadow-sm">
          <div className="text-xs font-semibold uppercase tracking-wide text-zinc-500">Case</div>
          <div className="mt-1 flex items-center justify-between">
            <div className="text-lg font-semibold">{caseId}</div>
            <div className="flex items-center gap-2">
              <Pill tone="blue">Master DOCX</Pill>
              <Pill tone="zinc">Multi-tenant</Pill>
            </div>
          </div>
        </div>
        {children}
